...
class StreamingServer:
    ...
    def broadcast(self, data):
        for client_address in self.__clients:
            data = encryption.encrypt_AES(data, self.__clients_ciphers[client_address][0],
                                          self.__clients_ciphers[client_address][1])
    ...
    def handle_data(self):
        ...
        while True:
            ...
            if data == b'Q':
                ...
                data = encryption.decrypt_AES(data, self.__clients_ciphers[client_address][0],
                                              self.__clients_ciphers[client_address][1])
    ...
    def handle_message(self, client):
        while True:
            try:
                ...
                client.close()
                self.broadcast(f"{self.nicknames[index]} disconnected to server!\n".encode('utf-8'))
